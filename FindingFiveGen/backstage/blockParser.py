...
def process_blockType(study_type,study_details,study_block):
	...
	for block_key,block_value in study_block.items():
		...
		if block_name.lower().startswith("welcome"):
			#print(block_value)
			block_info, cover_trials, main_trials, end_trials = TP.welcome(block_value,block_name,need_text)
			procedure.block(block_info, cover_trials, main_trials, end_trials)
		...
		# this block is used for surveys
			...
			block_info, cover_trials, main_trials, end_trials = TP.survey(block_value,block_name,need_text)
			procedure.block(block_info, cover_trials, main_trials, end_trials,order='fixed')
			#print(block_value)

		# this block is used for training
		elif block_name.lower().startswith("learn"):
			block_info, cover_trials, main_trials, end_trials = TP.learn(block_value,block_name,need_text)
			procedure.block(block_info, cover_trials, main_trials, end_trials)
			#print(block_value)

		# this block is used for comprhension (AFC)
		elif block_name.lower().startswith('understand'):
			block_info, cover_trials, main_trials, end_trials = TP.understand(block_value,block_name,need_text)
			procedure.block(block_info, cover_trials, main_trials, end_trials)
			#print(block_value)

		elif block_name.lower().startswith('speak'):
			block_info, cover_trials, main_trials, end_trials = TP.speak(block_value,block_name,need_text)
			procedure.block(block_info, cover_trials, main_trials, end_trials)
			#print(block_value)
